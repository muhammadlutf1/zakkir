...
test("fetchRadios returns MP3Quran-shaped radio entries", async (t) => {
...
test("fetchReciters returns MP3Quran-shaped reciter entries with rewayat", async (t) => {
	if (!online) return t.skip("MP3Quran API unreachable");
...
test("resolveRewayat returns only the rewayat that list the Surah", async (t) => {
	if (!online) return t.skip("MP3Quran API unreachable");
...
test("resolveStreamUrl returns a reachable stream URL", async (t) => {
	if (!online) return t.skip("MP3Quran API unreachable");
...
test("resolveRadioUrl returns the stream URL for a real Radio", async (t) => {
	if (!online) return t.skip("MP3Quran API unreachable");
